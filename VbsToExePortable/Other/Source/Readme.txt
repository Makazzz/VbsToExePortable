...
user in an INI file next to VbsToExePortable.exe called VbsToExePortable.ini.
...
copy AppNamePortable.ini from this directory to VbsToExePortable.ini next to
VbsToExePortable.exe. The options in the INI file are as follows:
